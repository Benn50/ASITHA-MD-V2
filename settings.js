...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=vvYlhJZY#9GS19u6idgWEoRA2J6_si7b7YjpUeYJ0TFeSHfrKn8c' : process.env.SESSION_ID,
...
NEWS_JID: process.env.NEWS_JID === undefined ? "true" : process.env.NEWS_JID,
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "true" : process.env.SEEDER_GMAIL,
